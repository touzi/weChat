...
<body>
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		...
		<form class="form-horizontal" id="form-auth" action="/publicAccount/update" method="POST">
			...
			<input type="hidden" name="publicAccount.ticket" value="2" />
			...
			<c:choose>
				<c:when
					test="${ 1 == publicAccount.ticket || '1' eq publicAccount.ticket }">
					<input style="margin-left: 180px;" class="btn btn-danger"
						type="submit" id="btn-submit"
						value="&nbsp;生&nbsp;成&nbsp;授&nbsp;权&nbsp;" />
				</c:when>
				<c:otherwise>
					<input style="margin-left: 180px;" class="btn btn-primary"
						type="submit" id="btn-submit"
						value="&nbsp;更&nbsp;新&nbsp;授&nbsp;权&nbsp;" />
				</c:otherwise>
			</c:choose>
...
<jsp:include page="/_back/headAndLeft.jsp"></jsp:include>
</body>
</html>